...
public class DefaultVisitor<R> implements Visitor<R> {
    ...
    @Override
    public <T extends AST> R visit(NodeList<T> ns) { throw new Error("Not implemented"); }
    ...
    @Override
    public R visit(ClassType n) { throw new Error("Not implemented"); }

    @Override
    public R visit(MethodType n) { throw new Error("Not implemented"); }
